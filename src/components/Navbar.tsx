  ...
  return (
    <nav className="bg-[#062832] text-white border-b-2 border-[#0a7f8f]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-[#0a7f8f]/30">
            ...
            <div className="flex gap-8">
              ...
              >
                ...
                {isAccountsDropdownOpen && (
                  <div
                    className="fixed left-0 right-0 top-[136px] z-50"
                    onMouseEnter={() => handleMouseEnter('accounts', setIsAccountsDropdownOpen)}
                    onMouseLeave={() => handleMouseLeave('accounts', setIsAccountsDropdownOpen)}
                  >
                    <div className="bg-[#062832] border-t-2 border-[#0a7f8f]">
                      <div className="max-w-7xl mx-auto px-6 py-8">
                      <div className="grid grid-cols-1 gap-8">
                        <div>
                          <h3 className="text-sm font-semibold text-[#14bfd8] mb-4 pb-2 border-b border-[#0a7f8f]/30">Accounts</h3>
                  ...
                  >
                    <div className="bg-[#062832] border-t-2 border-[#0a7f8f]">
                      <div className="max-w-7xl mx-auto px-6 py-8">
                        <div className="grid grid-cols-1 gap-8">
                        <div>
                          <h3 className="text-sm font-semibold text-[#14bfd8] mb-4 pb-2 border-b border-[#0a7f8f]/30">Loans</h3>
                          <div className="space-y-3">
                  ...
                  >
                    <div className="bg-[#062832] border-t-2 border-[#0a7f8f]">
                      <div className="max-w-7xl mx-auto px-6 py-8">
                        ...
                        <div>
                          <h3 className="text-sm font-semibold text-[#14bfd8] mb-4 pb-2 border-b border-[#0a7f8f]/30">Credit cards</h3>
                          <div className="space-y-3">
                        ...
                        <div>
                          <h3 className="text-sm font-semibold text-[#14bfd8] mb-4 pb-2 border-b border-[#0a7f8f]/30">Help</h3>
                          <div className="space-y-3">
                  ...
                  >
                    <div className="bg-[#062832] border-t-2 border-[#0a7f8f]">
                      <div className="max-w-7xl mx-auto px-6 py-8">
                        <div className="grid grid-cols-2 gap-8">
                        <div>
                          <h3 className="text-sm font-semibold text-[#14bfd8] mb-4 pb-2 border-b border-[#0a7f8f]/30">Investment accounts</h3>
                          <div className="space-y-3">
